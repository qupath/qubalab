...
class ImageFeature(geojson.Feature):
    ...
    def nucleus_geometry(self) -> geojson.geometry.Geometry:
        ...
        key when creating an ImageFeature, or by defining the 'nucleus_geometry'
        property of an ImageFeature.
        """
    ...
    @classmethod
    def _validate_rgb_value(self, value: Union[int, float]) -> int:
